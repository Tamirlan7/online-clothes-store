                ...
                <section className='item'>
                    <div className='item__image-container'>
                        <img
                            ...
                            src={`${API_URL}/product/${currentProduct.id}/file/${currentProduct.productMediaFiles[0].name}`}
                            alt='item'
                        />
                        <div></div>
                    </div>
                    <div className='item__container'>
                        <h1 className='item__title'>{currentProduct.name}</h1>
                        <ul className='item__info'>
                            <li>
                                Коллекция:
                                <span>{currentProduct.collection?.name}</span>
                            </li>
                            <li>
                                Артикул:
                                <span>{currentProduct.clothingType?.name}</span>
                            </li>
                            <li>
                                Характеристики:
