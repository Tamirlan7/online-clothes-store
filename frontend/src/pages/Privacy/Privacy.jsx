    ...
    <>
      <section className='privacy'>
        ...
        <p className='privacy__text'>
          1. Общие положенияНастоящая политика обработки персональных данных
          ...
          предпринимаемые ИП Петровым Иваном Сергеевичем, ОГРНИП
          323210000005404, ИНН 211300629266 (далее — Оператор).
          <br />
          <br />
          ...
          Оператор может получить о посетителях веб-сайта https://uncwear.ru/.  
          <br />
          <br />
          ...
          сети интернет по сетевому адресу https://uncwear.ru/.  
          <br />
          <br />
          ...
          <br />
          <br />
          2.10. Пользователь — любой посетитель веб-сайта https://uncwear.ru/.  
          <br />
          <br />
          ...
          <br />
          <br />
          6. Цели обработки персональных данных Цель обработки информирование
          Пользователя посредством отправки электронных писем Персональные
          данные: -фамилия, имя, отчество-электронный адрес-номера
          телефонов-адрес фактического места проживания и регистрации по месту
          жительства и/или по месту пребывания Правовые основания - Федеральный
          ...
          Оператора uncwearshop@gmail.com с пометкой «Актуализация персональных
          данных».  
          <br />
          <br />
          ...
          на электронный адрес Оператора uncwearshop@gmail.com с пометкой «Отзыв
          ...
          законом.12. Заключительные положения  
          <br />
          <br />
          ...
          Оператору с помощью электронной почты uncwearshop@gmail.com.  
          <br />
          <br />
