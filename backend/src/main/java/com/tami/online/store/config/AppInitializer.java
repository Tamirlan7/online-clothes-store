        ...
        products.add(
                Product.builder()
                        ...
                        .productSizes(List.of(
                                ProductSize.builder()
                                        .size("S")
                                        .additionalInfo("(155-170)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("M")
                                        .additionalInfo("(171-180)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("L")
                                        .additionalInfo("(181-190)")
                                        .quantity(25)
                                        .build()
                        ))
        ...
        products.add(
                Product.builder()
                        ...
                        .productSizes(List.of(
                                ProductSize.builder()
                                        .size("S")
                                        .additionalInfo("(165-172)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("M")
                                        .additionalInfo("(173-179)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("L")
                                        .additionalInfo("(180-186)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("XL")
                                        .additionalInfo("(187-193)")
                                        .quantity(25)
                                        .build()
                        ))
        ...
        products.add(
                Product.builder()
                        ...
                        .productSizes(List.of(
                                ProductSize.builder()
                                        .size("S")
                                        .additionalInfo("ширина/длина/рукав - 65/72/55 (на рост 165-175)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("M")
                                        .additionalInfo("ширина/длина/рукав - 70/74/55 (на рост 175-185)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("L")
                                        .additionalInfo("ширина/длина/рукав - 75/78/58 (на рост 185-195)")
                                        .quantity(25)
                                        .build()
                        ))
        ...
        products.add(
                Product.builder()
                        ...
                        .productSizes(List.of(
                                ProductSize.builder()
                                        .size("S")
                                        .additionalInfo("ширина/длина/рукав - 60/72/55 (на рост 165-170)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("M")
                                        .additionalInfo("ширина/длина/рукав - 62/74/55 (на рост 170-180)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
                                        .size("L")
                                        .additionalInfo("ширина/длина/рукав - 65/76/58 (на рост 180-185)")
                                        .quantity(25)
                                        .build(),
                                ProductSize.builder()
